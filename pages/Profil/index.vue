<template>
  ...
  <div class="card-body">
    ...
    <p class="card-text">TERWUJUDNYA LULUSAN YANG CERDAS, AKTIF, KOMPETITIF, ADAPTIF, DAN PRODUKTIF BERLANDASKAN IMAN DAN TAKWA
</p>

<h5 class="card-title">MISI</h5>
    <p class="text-start"><ol class=" list-group-numbered text-start">
